...
const SingleFood = () => {
    ...
    return (
        ...
        <View style={[styles.header,{paddingHorizontal:windowWidth*0.03,marginBottom:windowWidth*0.01,paddingVertical:windowWidth*0.07}]}>
        <TouchableOpacity>
        ...
        <Image style={{width:'100%', height:'100%',borderRadius:windowWidth*0.5}} source={{uri:SingleF.img}}    />
        </TouchableOpacity>
        </View>
        <ScrollView style={{flex:1}}>
        <TouchableOpacity style={{width:windowWidth*0.97, height:windowWidth*0.82,alignSelf:'center',marginBottom:windowWidth*0.1}}>
            <Image resizeMode="cover" style={{width:'100%', height:'100%'}} source={require('../assets/ramen.jpg')}    /></TouchableOpacity>
        ...
        <Text style={{fontSize:windowWidth*0.04,lineHeight:30,width:windowWidth*0.920,marginBottom:windowWidth*0.04}}> 
        {SingleF.description}
        </Text>
